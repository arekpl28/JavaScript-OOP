...
class Game extends UI {
  ...
  #handleCellContextMenu = (e) => {
    ...
    if (cell.isReveal || this.#isGameFinised) return;
  ...
  #clickCell(cell) {
    if (this.#isGameFinised || cell.isFlagged) {
      return;
    }
    ...
    if (this.#revealedCells === this.#cellsToReveal && !this.#isGameFinised) {
      this.#endGame(true);
    }
  }
